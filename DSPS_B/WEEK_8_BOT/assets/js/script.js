...
function addMessage(message, isBot) {
    ...
    if (isBot) rowElement.classList.add("message-bot");

    // Create message
    var messageEl = document.createElement("div"); // <div></div>
    messageEl.classList.add("message"); // <div class="message"></div>
    messageEl.innerHTML = message; // <div class=message">How Are You? </div>

    rowElement.appendChild(messageEl);
